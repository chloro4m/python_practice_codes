#implement queue w/ linked lists
...
class queueLL:
    ...
    def enqueue(self, item): #will make the head as the rear/enqueue end
        self.queue.add(item)

    def dequeue(self): #will make the tail of list as front/dequeue end
